...
document.addEventListener('DOMContentLoaded', function() {
	  ...
	  var form = document.getElementById("forminator-module-16131");
        ...
        if (form) {
            form.addEventListener('submit', function(event) {
                ...
                var formFields = {
                    ...
                    "website":formData.get('url-1'),
                    "message": formData.get('textarea-1')
                };
                ...
                var payload = {
                    ...
                    "campaignName": "unicalacademycontact_camp",
