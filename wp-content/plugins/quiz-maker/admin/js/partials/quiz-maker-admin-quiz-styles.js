(function($){
    ...
    $(document).ready(function(){
        ...
        let live_width = (parseInt($(document).find('#ays-quiz-width').val()) !== 0) ? $(document).find('#ays-quiz-width').val() + 'px' : '100%';
...
//        $(document).find('.ays-quiz-live-image').attr('src', $(document).find('#ays-quiz-img').attr('src'));
        ...
        $(document).find('#ays-quiz-width').on('change', function (e) {
            let live_width = (parseInt(e.target.value) !== 0) ? e.target.value + 'px' : '100%';
