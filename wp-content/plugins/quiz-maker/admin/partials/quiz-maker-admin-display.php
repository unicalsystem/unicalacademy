...
$questions_page_url = sprintf('?page=%s&action=%s', 'quiz-maker-questions', 'add');
    ...
    <div class="ays-quiz-faq-main">
        ...
        <fieldset>
            <div class="ays-quiz-ol-container">
                <ol>
                    <li>
                        <?php echo __("Go to the", $this->plugin_name ) . " <a href='". $questions_page_url ."' target='_blank'>" . __("Questions", $this->plugin_name )."</a> " .  __( "page and create new questions", $this->plugin_name ); ?>,
                    </li>
                    <li>
