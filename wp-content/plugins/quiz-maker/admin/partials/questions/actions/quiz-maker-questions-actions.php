...
$question_title = (isset($question['question_title']) && $question['question_title']) ? htmlspecialchars( $question['question_title'], ENT_QUOTES ) : '';
    ...
    <div class="container-fluid">
        ...
        <form method="post" id="ays-question-form">
            ...
            <div id="tab1" class="ays-quiz-tab-content <?php echo ($ays_question_tab == 'tab1') ? 'ays-quiz-tab-content-active' : ''; ?>">
                ...
                <hr/>
                <div class="form-group row show_for_custom_type <?php echo $is_custom_type ? "" : "display_none"; ?>">
                    <div class="col-sm-4">
                ...
                <hr class="show_for_custom_type <?php echo $is_custom_type ? "" : "display_none"; ?>" />
            ...
            <div id="tab2" class="ays-quiz-tab-content <?php echo ($ays_question_tab == 'tab2') ? 'ays-quiz-tab-content-active' : ''; ?>">
                ...
                <div class="form-group row hide_for_custom_type <?php echo ($is_custom_type) ? 'display_none' : ''; ?>">
                    <div class="col-sm-4">
                        <label for="wrong_answer_text">
                            <?php echo __('Message for the wrong answer ',$this->plugin_name)?><sup>(<?php echo __('only for radio type',$this->plugin_name); ?>)</sup>
                ...
                <div class="form-group row hide_for_custom_type <?php echo ($is_custom_type) ? 'display_none' : ''; ?>">
                    <div class="col-sm-4">
                        <label for="right_answer_text">
                            <?php echo __('Message for the right answer ',$this->plugin_name)?><sup>(<?php echo __('only for radio type',$this->plugin_name); ?>)</sup>
