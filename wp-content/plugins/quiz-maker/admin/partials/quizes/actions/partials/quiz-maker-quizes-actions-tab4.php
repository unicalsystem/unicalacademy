<div id="tab4" class="ays-quiz-tab-content <?php echo ($ays_quiz_tab == 'tab4') ? 'ays-quiz-tab-content-active' : ''; ?>">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8 ays_toggle_parent">
            <label class="ays_quiz_loader">
                <input name="ays_quiz_loader" class="ays_toggle_radio" data-flag="false" type="radio" value="default" <?php echo ($quiz_loader == 'default') ? 'checked' : ''; ?>>
                <div class="lds-ellipsis"><div></div><div></div><div></div><div></div></div>
            </label>
            <label class="ays_quiz_loader">
                <input name="ays_quiz_loader" class="ays_toggle_radio" data-flag="false" type="radio" value="circle" <?php echo ($quiz_loader == 'circle') ? 'checked' : ''; ?>>
                <div class="lds-circle"></div>
            </label>
            <label class="ays_quiz_loader">
                <input name="ays_quiz_loader" class="ays_toggle_radio" data-flag="false" type="radio" value="dual_ring" <?php echo ($quiz_loader == 'dual_ring') ? 'checked' : ''; ?>>
                <div class="lds-dual-ring"></div>
            </label>
            <label class="ays_quiz_loader">
                <input name="ays_quiz_loader" class="ays_toggle_radio" data-flag="false" type="radio" value="facebook" <?php echo ($quiz_loader == 'facebook') ? 'checked' : ''; ?>>
                <div class="lds-facebook"><div></div><div></div><div></div></div>
            </label>
            <label class="ays_quiz_loader">
                <input name="ays_quiz_loader" class="ays_toggle_radio" data-flag="false" type="radio" value="hourglass" <?php echo ($quiz_loader == 'hourglass') ? 'checked' : ''; ?>>
                <div class="lds-hourglass"></div>
            </label>
            <label class="ays_quiz_loader">
                <input name="ays_quiz_loader" class="ays_toggle_radio" data-flag="false" type="radio" value="ripple" <?php echo ($quiz_loader == 'ripple') ? 'checked' : ''; ?>>
                <div class="lds-ripple"><div></div><div></div></div>
            </label>
            <label class="ays_quiz_loader">
                <input name="ays_quiz_loader" class="ays_toggle_radio" data-flag="true" type="radio" value="text" <?php echo ($quiz_loader == 'text') ? 'checked' : ''; ?>>
                <div class="ays_quiz_loader_text">
                    <?php echo __( "Text" , $this->plugin_name ); ?>
                </div>
                <div class="ays_toggle_target ays_divider_left <?php echo ($quiz_loader == 'text') ? '' : 'display_none' ?>">
                    <input type="text" class="ays-text-input" id="ays_quiz_loader_text_value" name="ays_quiz_loader_text_value" value="<?php echo $quiz_loader_text_value; ?>">
                </div>
            </label>
        </div>
...
<!--
    <div class='ays-field-dashboard'>
        ...
        <div>
            <label class="ays_quiz_loader">
                <input type="radio" class="ays-enable-timer1 ays_table_by ays_perc_count" name="ays_display_score_by" value="by_percentage" <?php echo ($display_score_by == 'by_percentage') ? 'checked' : ''; ?>>
                <span><?php echo __( "By percentage", $this->plugin_name ); ?></span>
            </label>
            <label class="ays_quiz_loader">
                <input type="radio" class="ays-enable-timer1 ays_table_by ays_point_count" name="ays_display_score_by" value="by_points" <?php echo ($display_score_by != 'by_percentage') ? 'checked' : ''; ?>>
                <span><?php echo __( "By points", $this->plugin_name ); ?></span>
            </label>
        </div>
    </div>
            ...
            <?php
                ...
                foreach ($quiz_intervals as $key => $quiz_interval) {
                    ...
                    if (isset($quiz_interval['interval_min']) && !empty($quiz_interval['interval_max']) || isset($quiz_interval['interval_keyword'])) {
                        ...
                        <?php
                            $selected_product = "";
                            if(isset($quiz_interval['interval_wproduct']) && intval($quiz_interval['interval_wproduct']) != 0){
                                $prod_id = intval($quiz_interval['interval_wproduct']);
                                $woo_selected_products[] = $prod_id;
                                $product = $this->ays_get_woocommerce_product( $prod_id );
                                $selected_product = "<option selected data-nkar='". $product->image ."' value='". $product->ID ."'>". $product->post_title ."</option>";
                            }
                            ?>
                            <td>
