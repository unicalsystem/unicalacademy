    ...
    <div class="ays-top-menu-wrapper">
        ...
        <div class="ays-top-menu">
            <div class="nav-tab-wrapper ays-top-tab-wrapper">
                <a href="?page=quiz-maker-each-result&quiz=<?php echo $quiz_id; ?>&ays_result_tab=poststuff" class="no-js nav-tab" ><?php echo __("Results", $this->plugin_name); ?></a>
                <a href="?page=quiz-maker-not-finished-results&quiz=<?php echo $quiz_id; ?>&ays_result_tab=not_finished_result" class="no-js nav-tab nav-tab-active" ><?php echo __("Not Finished", $this->plugin_name); ?></a>
                <a href="?page=quiz-maker-each-result&quiz=<?php echo $quiz_id; ?>&ays_result_tab=statistics" class="no-js nav-tab"><?php echo __("Statistics", $this->plugin_name); ?></a>
                <a href="?page=quiz-maker-each-result&quiz=<?php echo $quiz_id; ?>&ays_result_tab=questions" class="no-js nav-tab"><?php echo __("Questions", $this->plugin_name); ?></a>
                <a href="?page=quiz-maker-each-result&quiz=<?php echo $quiz_id; ?>&ays_result_tab=quest_cat_stat" class="no-js nav-tab"><?php echo __("Question category statistics", $this->plugin_name); ?></a>
                <a href="?page=quiz-maker-each-result&quiz=<?php echo $quiz_id; ?>&ays_result_tab=leaderboard" class="no-js nav-tab"><?php echo __("Leaderboard", $this->plugin_name); ?></a>
                <a href="<?php echo "?page=".$this->plugin_name."-all-reviews&quiz=$quiz_id"; ?>" class="no-js nav-tab"><?php echo __('Reviews',$this->plugin_name)?></a>
            </div>
        </div>
