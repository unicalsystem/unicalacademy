...
class All_Results_List_Table extends WP_List_Table{
    ...
    public function extra_tablenav( $which ){
        ...
        <div id="quiz-filter-div" class="alignleft actions bulkactions">
            ...
            <select name="userby" class="ays-search-users-select" id="bulk-action-select2-<?php echo $which ?>" >
            ...
            <input type="button" id="doaction" class="all-results-filter-apply button" value="Filter">
