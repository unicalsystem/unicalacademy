...
const THIM_THEME_VERSION = '5.3.2.1';
/**
...
/**
 * text changing from billing Detials to Your Details
 */
...
function wc_custom_order_button_text() {
    return __( 'Proceed to Pay', 'woocommerce' ); 
}
...
function woocommerce_add_to_cart_button_text_single() {
    return __( 'Enroll Course', 'woocommerce' ); 
}
