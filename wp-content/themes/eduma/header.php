...
<head>
	<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-JHQFHJ9N7T"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-JHQFHJ9N7T');
</script>
	

			<!-- google serach console tag-->
	<meta name="google-site-verification" content="beJQkx4Y2pzKlVlCh608F4lvEF59DL2TOlsCQtca5N8" />
